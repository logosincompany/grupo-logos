...
export default function Navbar({ onOpenProposal }: NavbarProps) {
  ...
  return (
    <>
      ...
      <div
        className={`lg:hidden fixed inset-0 z-40 bg-black/60 backdrop-blur-sm transition-opacity duration-500 ${
      ...
      {/* Mobile Drawer Menu */}
      <div
        className={`lg:hidden fixed inset-y-0 right-0 z-50 w-full max-w-xs bg-navy-950 border-l border-gold-500/10 shadow-2xl p-6 transition-all duration-500 transform ${
